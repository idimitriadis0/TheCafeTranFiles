...
- Export button becomes Finalize button in CafeTran’s segments grid. This sets the translated status to all target segments and saves the project. Generally, this step should be performed prior to delivering the files.
